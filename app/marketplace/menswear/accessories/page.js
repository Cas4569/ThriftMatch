      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-12">
          ...
          <div className="relative">
            ...
            {/* Purple → Gold accent */}
            <div className="mt-3 h-1 w-32 rounded-full bg-gradient-to-r from-[#7e22ce] via-[#c6a15b] to-transparent shadow-[0_0_18px_rgba(198,161,91,0.45)]" />
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="p-7">
                ...
                {/* Tag */}
                {product.tag && (
                  <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.25em] text-[#c6a15b]">
                    // {product.tag}
                  </p>
                )}
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <h2 className="text-xl font-black leading-tight tracking-tight transition duration-300 group-hover:text-[#e0c486]">
                    {product.name}
                  </h2>

                  <p className="shrink-0 text-lg font-black text-[#c6a15b]">
                    {product.price}
                  </p>
                ...
                <a
                  ...
                  className="mt-5 inline-flex rounded-full border border-[#5b3180] px-5 py-2.5 text-sm font-bold text-[#d8b4fe] transition duration-300 hover:border-[#c6a15b] hover:bg-[#32174D] hover:text-[#e0c486] hover:shadow-[0_0_20px_rgba(198,161,91,0.2)]"
                >
                  View →
                </a>
        ...
        <div className="mt-14 flex flex-col gap-3 border-t border-[#32174D] pt-5 text-[9px] font-bold uppercase tracking-[0.25em] text-[#65477a] sm:flex-row sm:items-center sm:justify-between">
          ...
          <span>
            THRIFTMATCH // MENSWEAR_ACCESSORIES_DATABASE
          </span>
