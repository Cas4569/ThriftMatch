      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative mb-12">
          <form
            ...
            method="get"
            className="flex w-full items-center overflow-hidden rounded-full border border-[#5a5348] bg-[#24221e] transition focus-within:border-[#d19a9a]"
          >
            <input
              type="text"
              name="query"
            ...
            <button
              ...
              title="Search"
              className="mr-2 shrink-0 rounded-full bg-[#d19a9a] px-5 py-3 text-sm font-bold text-[#171512] transition hover:bg-[#e4b4b4]"
            >
